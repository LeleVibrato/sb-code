...
def get_metadata(
    ...
    from_ = datetime.datetime.strptime(from_, "%Y-%m-%d") if from_ else today - datetime.timedelta(days=60)
...
def download_decisions(
    ...
    output_dir: Path = typer.Argument("decision", help="The path to the output directory"),
):
